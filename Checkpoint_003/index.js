...
let aluno001 = new estudantes.AddAluno("Alisson", 2, [4.5, 7, 9]);
let aluno002 = new estudantes.AddAluno("Alice", 4, [3, 6.5, 8]);
let aluno003 = new estudantes.AddAluno("Manoel", 1, [5, 7, 8]);
let aluno004 = new estudantes.AddAluno("Luna", 5, [3.5, 4.7, 6]);
let aluno005 = new estudantes.AddAluno("Pedro", 0, [6, 7, 8]);
